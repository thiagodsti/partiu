"""Repository for the in-app ``notifications`` table (the persistent inbox).

Push delivery is a separate concern — see push_repository.py.
"""

from ..database import db_conn, db_write
from ..utils import now_iso
from .domain import Notification
from .mappers import row_to_notification
