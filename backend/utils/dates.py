"""
Date/flight-number helper functions used across the backend. Pure functions
only — no database or filesystem access (see ../airports/timezone.py for
airport-table-backed date logic, i18n.py for locale files).
"""
